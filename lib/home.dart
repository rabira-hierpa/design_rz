          ...
          children: <Widget>[
              ...
              child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => IllustratorDesign(
                              pageDesign: 'Illustrator Designs',
                            )));
                  },
                  child: Container(
                    margin: EdgeInsets.fromLTRB(0, 10, 0, 10),
            ...
            Expanded(
                child: GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => IndesignDesign(
                                pageDesign: 'InDesign Designs',
                              )));
                    },
                    child: Container(
                      margin: EdgeInsets.fromLTRB(0, 10, 0, 10),
